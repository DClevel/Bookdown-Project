...
```{r 6 setup, warning=F,message=F, echo=FALSE}
library(tidyverse)
library(tidyr)
library(ggthemes)
library(lubridate)
...
#knitr::opts_knit$set(root.dir='C:/Users/DClev/Documents/ESS580_copied_folder/Bookdown_Proj/Bookdown2')
...
```{r 7 dataread, warning=F,message=F}
...
### Bonus Question 2: Use Climage Engine to pull the same data for the assignment, but updated with 2020/2021 data.
