...
author: "Daniel Cleveland and Matthew Ross"
date: "3/21/2022"
...
```{r}
wq_sr <- read_csv('data_descent/wq_sr.csv') %>%
...
```{r}
set.seed(333) ## Makes the work reproducible, but you can hack this!
...
### TSS plot  (don't have to do this...)
...
### TSS Evaluation  (don't have to do this...)
...
I achieved the lowest CHLA RMSE value by adjusting the following parameters to following values:

eta = 0.07
lambda = 1
seed = 333

The CHLA RMSE associated with these values was **22.777**.


- or -


# Q2) What is the best TSS RMSE you could get after 50 minutes of fiddling?
